...
* Challenge technique chez soi, sans limite de temps
...
* L'équipe
* Les produits/services: métier, ce qu'il résout, sa stack technique...
* Infrastructure
* Pratique de l'équipe: la mise en prod, la qualité, les tests, codes reviews...
...
* Poster une annonce sur un jobboard type remixjob, selon les communautés (~200€)
...
* Lien vers une vidéo (privée) de présentation de l'équipe, des produits...
...
* On essaie de le faire rebondir par rapport au contenu: test, code review, continuous delivery...
* `Que pourriez-vous proposer pour améliorer/aider l’équipe (process, outils...)`
* L'ammener à parler de sa dernière expérience: `Qu'est ce que vous aimez dans votre job actuel?`
* Et la question en creux `Ce qui vous plaît moins?`
...
* Comment organisez-vous votre veille tech?
* Quel est le dernier gros challenge technique auquel vous avez dû faire face?
* Qu’est qui fait qu’un code est bon?
* A quoi sert une Interface en POO?
* De quoi est composée une requête HTTP
* Comment gardez-vous une vision claire de votre prod backend?
* Vous avez une grosse charge sur l’un de vos services. Comment faîtes-vous pour la gérer?
* Avantage/inconvénient de la techno
* Une/Deux question spécifique au language
...
* Fait à la maison
* Définir une deadline avec le candidat (15j s'il le faut)
* L'exercice doit être décrit avec précision
...
* Source du recrutement: spontanée, talent.io, remixjob...
...
* ~70 candidats rencontrés, au moins en vidéo conférence
...
* le bon contact avec toi (il veut déjà une augmentation 😄) et l’équipe
* prétention salariale OK sans discussion
* le challenge technique qui pose des questions pertinentes et qui m’ont permis d’avoir un bon aperçu de où j’allais
